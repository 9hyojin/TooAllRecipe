...
public class RecipeService {
    ...
    public void save(RecipeDTO recipeDTO) throws IOException{
        ...
        if (recipeDTO.getFile().isEmpty()) {
            ...
            for (MultipartFile files : recipeDTO.getFile()) {
                try {
                    files = (MultipartFile) recipeDTO.getFile();
                    String originalFilename = recipeDTO.getOriginalFileName(); // 2.
                    ...
                    files.transferTo(new File(savePath)); // 5.
